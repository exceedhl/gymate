...
@property (nonatomic, retain) SVSegmentedControl *segmentedControl;
@property (nonatomic, retain) UIFont *font;

@property (retain, nonatomic, readonly) UILabel *label;
@property (retain, nonatomic, readonly) UILabel *secondLabel;
...
- (UILabel*)secondLabel {
    ...
    if(secondLabel == nil) {
		secondLabel = [[[UILabel alloc] initWithFrame:self.bounds] autorelease];
